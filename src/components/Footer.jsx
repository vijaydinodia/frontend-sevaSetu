  ...
  return (
    <footer className="bg-zinc-950 text-zinc-400 py-12 px-5 border-t border-zinc-800 mt-auto">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h4 className="text-xs font-bold uppercase tracking-wider text-white mb-4">Legal & Policy</h4>
          <div className="flex flex-col gap-2 text-sm">
            ...
            <Link to="/become-provider" className="text-amber-500 font-semibold hover:underline">
