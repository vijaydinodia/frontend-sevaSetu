      ...
      <section style={styles.hero}>
        ...
        <div style={{ textAlign: 'center', marginTop: 48 }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 12, marginTop: 12 }}>
            Already applied? <a href="/login" style={{ color: '#f59e0b', fontWeight: 600, textDecoration: 'none' }}>Log in here →</a>
          </p>
        </div>
      </section>
        ...
        <section ref={formRef} style={styles.formSection}>
          <div style={styles.formCard}>
            ...
            <div style={styles.formHeader}>
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#111827' }}>Provider Registration</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {activeStep === 0 && (
                <div style={styles.stepPane}>
                  ...
                  <div style={styles.navRow}>
                    <div />
                    <button type="button" style={styles.nextBtn} onClick={() => setActiveStep(1)}>
              ...
              {activeStep === 1 && (
                <div style={styles.stepPane}>
                  ...
                  <div style={styles.navRow}>
                    <button type="button" style={styles.backBtn} onClick={() => setActiveStep(0)}>← Back</button>
                    <button type="button" style={styles.nextBtn} onClick={() => setActiveStep(2)}>Next: Documents →</button>
                  </div>
                </div>
              )}
              ...
              {activeStep === 2 && (
                <div style={styles.stepPane}>
                  ...
                  <div style={styles.navRow}>
                    <button type="button" style={styles.backBtn} onClick={() => setActiveStep(1)}>← Back</button>
                    <button
                      type="submit"
                      disabled={loading}
