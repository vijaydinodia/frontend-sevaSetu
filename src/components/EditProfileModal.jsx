...
// uploadEndpoint - where to upload the image (different per role)
// profileEndpoint - where to save the updated profile
// both are full URL strings passed from the parent
